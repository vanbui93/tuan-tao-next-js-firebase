...
const AdminProduct = props => {
  ...
  const handleChangePromotion = promotionId => e => {
    if (ckPromotionIds?.includes(promotionId)) {
      ...
      const newArrWithAddedPromotion = [...editObject.promotions, { promotion_id: promotionIndex[0].promotion_id }]
                    ...
                    Object.values(currentList)?.map((product, idx) => (
                      <StyledTableRow key={idx}>
                        ...
                        <StyledTableCell align='left'>
                          {product?.price ? `${numberInputFormat(product?.price.toString())} đ` : 'Liên hệ'}{' '}
                        </StyledTableCell>
                        ...
                        <StyledTableCell align='right'>
                          <Fab size='small' color='primary' aria-label='add' onClick={() => handleEditProduct(product)}>
                            <EditIcon />
                          </Fab>
                        </StyledTableCell>
                        <StyledTableCell align='right'>
                          <Fab size='small' color='primary' aria-label='add' onClick={() => handleDelete(product?.id)}>
                            <DeleteIcon />
                          </Fab>
                        </StyledTableCell>
                      </StyledTableRow>
                            ...
                            <div className={classes.imgUpload}>
                              <UploadControl onChange={handleAddImg} accept='image/*'>
                                <div className={classes.imgUploadText} align='center'>
                                  <svg className='svg-next-icon svg-next-icon-size-48' width='48' height='48'>
