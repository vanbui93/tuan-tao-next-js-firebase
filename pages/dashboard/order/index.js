                      ...
                      return (
                        order && (
                          <StyledTableRow key={idx}>
                            ...
                            <StyledTableCell>
                              {order.price ? `${numberWithCommas(order.price)} đ` : 'Liên hệ'}
                            </StyledTableCell>
                            <StyledTableCell>
                              <span className={classes.pColor} style={{ backgroundColor: `${order.color}` }}></span>
                            </StyledTableCell>
                            ...
                            <StyledTableCell align='right'>
                              <Fab size='small' color='primary' aria-label='add' onClick={() => handleViewOrder(order)}>
                                <RemoveRedEyeIcon />
                              </Fab>
                            </StyledTableCell>
                            <StyledTableCell align='right'>
                              <Fab size='small' color='primary' aria-label='add' onClick={() => handleDelete(order.id)}>
                                <DeleteIcon />
                              </Fab>
                            </StyledTableCell>
                          </StyledTableRow>
              ...
              <div>
                <Grid style={{ paddingBottom: '20px' }}>
                  <Stack spacing={2} direction='row' style={{ paddingTop: '20px' }}>
                    <Button variant='contained' color='secondary' onClick={() => handleEditOrder(viewObject)}>
                      <EditIcon />
                      Sửa đơn hàng
                    </Button>
                    ...
                    {viewObject !== null && viewObject !== undefined && (
                      <TableBody>
                                ...
                                {allPromotions !== null &&
                                  ...
                                  Object.values(allPromotions)?.map((item, idx) => {
                                    if (ckPromoViewId?.includes(item.promotion_id)) {
                                      return <li key={idx}>- {item.promotion_text}</li>
                                    }
                                  })}
                              </ul>
                            </TableCell>
                        ...
                        <TableRow>
                          ...
                          <TableCell>{numberInputFormat(viewObject.price.toString())}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell className={classes.tbHeadLeft} variant='head'>
                            Tình trạng mới
                          </TableCell>
                          <TableCell>{viewObject.fullbox === 1 ? 'Đã sử dụng' : 'Fullbox'}</TableCell>
                        </TableRow>
                        {viewObject.newBox ? (
                          <TableRow>
                            <TableCell className={classes.tbHeadLeft} variant='head'>
                                ...
                                <TextField
                                  ...
                                  defaultValue={
                                    editObject.product_price
                                      ? numberInputFormat(editObject.product_price.toString())
                                      : ''
                                  }
                                  name='product_price'
                                  onChange={handleEditOnchage}
