...
import { deleteSku, getSkus, updateSku } from 'actions/skus';
...
const AdminSku = (props) => {
  ...
  const arraySku = [];
  skus !== null && skus !== undefined && Object.keys(skus)?.map((element) => {
    const key = element;
    if (skus[key] !== null) {
  ...
  const handleAddAccount = () => {
    navigate("/dashboard/sku_add", { replace: true })
  }
          ...
          <div>
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                ...
                <TableBody>
                  {arraySku !== null && arraySku !== undefined &&
