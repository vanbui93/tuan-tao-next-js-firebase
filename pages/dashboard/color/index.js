                        ...
                        color !== undefined && (
                          <StyledTableRow key={idx}>
                            ...
                            <StyledTableCell align='right'>
                              <Fab size='small' color='primary' aria-label='add' onClick={() => handleEdit(color)}>
                                <EditIcon />
                              </Fab>
                            </StyledTableCell>
                            <StyledTableCell align='right'>
                              <Fab size='small' color='primary' aria-label='add' onClick={() => handleDelete(color.id)}>
                                <DeleteIcon />
                              </Fab>
                            </StyledTableCell>
                          </StyledTableRow>
