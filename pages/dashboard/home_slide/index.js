...
import { deleteSlide, getSlides, updateSlide } from '../../../store/actions/slides'
...
const AdminSlide = props => {
  ...
  allSlides !== null &&
    allSlides !== undefined &&
    Object.keys(allSlides)?.map(element => {
      const key = element
  ...
  const handleAddSlide = () => {
    router.push('/dashboard/home_slide_add')
  }
          ...
          <div>
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 700 }} aria-label='customized table'>
                ...
                <TableBody>
                  {arraySlide !== null &&
                    arraySlide !== undefined &&
                    Object.values(arraySlide)?.map(
                      (item, idx) =>
                        item && (
                          <StyledTableRow key={idx}>
                            ...
                            <StyledTableCell align='right'>
                              <Fab size='small' color='primary' aria-label='add' onClick={() => handleEditSlide(item)}>
                                <EditIcon />
                              </Fab>
                            </StyledTableCell>
                            <StyledTableCell align='right'>
