  ...
  return (
    <div className='thankyou'>
      ...
      <span className='checkout__message'>
        <i className='fa fa-check-circle' aria-hidden='true'></i>Cảm ơn vì đã quan tâm đến sản phẩm của chúng tôi. Bạn
        vui lòng đợi trong giây lát để hệ thống xử lý đơn hàng của bạn.
      </span>
