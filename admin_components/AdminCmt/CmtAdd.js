...
import { addCommentObject, getComments } from 'actions/cmt';
...
const CmtAdd = (props) => {
  ...
  //Cập nhật link hình vào set Avatar
  useEffect(() => {
    setCmt(prevState => ({
      ...prevState,
      image: result
      ...
      <Grid>
        <TableContainer component={Paper}>
          <Table>
            <TableBody>
              <TableRow>
                <TableCell className={classes.tbHeadLeft} variant="head">Khách hàng</TableCell>
                <TableCell>
                  <TextField
              ...
              <TableRow>
                <TableCell className={classes.tbHeadLeft} variant="head">Avatar</TableCell>
                <TableCell>
                  <Grid container spacing={2}>
                    <Grid item xs={3}>
                      {result && <img className={classes.thumbnail} ref={imageRef} src={result} alt="" />}
                    </Grid>
                    <Grid item xs={7}>
...
export default withStyles(styles)(CmtAdd)