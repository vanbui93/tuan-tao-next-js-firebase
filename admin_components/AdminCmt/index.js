import { Button, Fab, Grid, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextareaAutosize, TextField, withStyles } from '@material-ui/core';
import AddIcon from '@mui/icons-material/Add';
import DeleteIcon from '@mui/icons-material/Delete';
import EditIcon from '@mui/icons-material/Edit';
import { Stack } from '@mui/material';
import Paper from '@mui/material/Paper';
import { deleteComment, getComments, updateComment } from 'actions/cmt';
...
const AdminCmts = (props) => {
  ...
  const arrayComment = [];
  cmts !== null && cmts !== undefined && Object.keys(cmts)?.map((element) => {
    const key = element;
    if (cmts[key] !== null) {
  ...
  const handleAddAccount = () => {
    navigate("/dashboard/comment_add", { replace: true })
  }
          ...
          <div>
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                ...
                <TableBody>
                  {arrayComment !== null && arrayComment !== undefined &&
                    Object.values(arrayComment)?.map((item, idx) => {
                      return (
                        ...
                        <StyledTableRow key={idx}>
                          ...
                          <StyledTableCell>{item.name ? item.content : ''}</StyledTableCell>
              ...
              <Table>
                {
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell className={classes.tbHeadLeft} variant="head">Nội dung nhận xét</TableCell>
                      <TableCell>
                        <TextField
                    ...
                    <TableRow>
                      <TableCell className={classes.tbHeadLeft} variant="head">Hình ảnh</TableCell>
                      <TableCell>
                        <Grid container spacing={2}>
                          <Grid item xs={3}>
                            {
                              <img className={classes.thumbnail} src={editCmtObject.image} alt='/' loading="lazy" />
                            }
                          </Grid>
                          <Grid item xs={7}>
                    ...
                    <TableRow>
                      <TableCell className={classes.tbHeadLeft} variant="head">Chức vụ</TableCell>
                      <TableCell>
                        <TextField
                          id="outlined-size-small"
                          size="small"
