import { Button, Fab, FormControl, FormControlLabel, FormLabel, Grid, Radio, RadioGroup, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, TextField, withStyles } from '@material-ui/core';
import AddIcon from '@mui/icons-material/Add';
import DeleteIcon from '@mui/icons-material/Delete';
import EditIcon from '@mui/icons-material/Edit';
import { Stack } from '@mui/material';
import Paper from '@mui/material/Paper';
import { deletePageDetail, getPageDetail, updatePageDetail } from 'actions/page';
...
const AdminPage = (props) => {
  ...
  const arrayPage = [];
  pageData !== null && pageData !== undefined && Object.keys(pageData)?.map((element) => {
    const key = element;
  ...
  const handleAddAccount = () => {
    navigate("/dashboard/page_add", { replace: true })
  }
          ...
          <div>
            ...
            <TableContainer component={Paper}>
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                ...
                <TableBody>
                  {arrayPage !== null && arrayPage !== undefined &&
              ...
              <Table>
                {
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell className={classes.tbHeadLeft} variant="head">Trạng thái hiển thị</TableCell>
                      <TableCell>
                        <FormControl>
                          <RadioGroup
                            row
