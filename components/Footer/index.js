                ...
                <div className='footer__col'>
                  ...
                  <ul className='footer__list'>
                    <li className='footer__item'>
                      <Link
                        href={`page/${footerData.footer_sub?.link_01}`}
                    ...
                    <li className='footer__item'>
                      <Link
                        href={`page/${footerData.footer_sub?.link_02}`}
                        onClick={() => window.scrollTo(0, 0)}
                        passHref
                      >
                    ...
                    <li className='footer__item'>
                      <Link
                        href={`page/${footerData.footer_sub?.link_03}`}
                        onClick={() => window.scrollTo(0, 0)}
                        passHref
                      >
                    ...
                    <li className='footer__item'>
                      <Link
                        href={`page/${footerData.footer_sub?.link_04}`}
                        onClick={() => window.scrollTo(0, 0)}
                        passHref
                      >
